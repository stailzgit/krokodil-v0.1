    ...
    <div className="rules page-wrap">
      ...
      <div className="rules__body">
        ...
        <ul className="rules__list">
          ...
          <li>2) произносить слоги и буквы (даже без звука, одними губами);</li>
          <li>3) показывать буквы или передавать буквы языком жестов.</li>
        </ul>
        <br />
        <p>
          Тем временем остальные игроки (или его команда) стараются понять
          задуманное и высказывают предположения. Игра идёт до тех пор, пока не
          угадают загаданное или не «выбросят белый флаг».
        </p>
      </div>
      <GoToMain />
    </div>
