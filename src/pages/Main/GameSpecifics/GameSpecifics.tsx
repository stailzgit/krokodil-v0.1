    ...
    <div className="specifics page-wrap">
      ...
      <div className="specifics__body">
        ...
        <p>
          ...
          количество очков указанное в настройках игры. При этом нужно завершить
          круг ходов. При достижении максимальных очков несколькими игроками -
          игра продолжается до тех пор, пока кто-то не вырвется вперед по итогам
          пройденного круга
        </p>
      </div>
